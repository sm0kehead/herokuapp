...
public class DropdownPage {
    ...
    public DropdownPage printAndAssertDropdownOptions(){
    ...
    public DropdownPage selecetOption(){
        WaitForElement.waitUntilElementsIsClickable(optionsDropdown);
    ...
    public DropdownPage assertHeader(){
        WaitForElement.waitUntilElementsIsVisible(header);
        header.getTagName();
        System.out.println(header);
        return this;
        //jAssert.assertEquals(header,"Dropdown List");
    }
}
